...
if (isset($_GET['logout'])) {
    session_destroy();
    header('Location: ../index.php'); // Parent folder ke index.php par jayega
    exit();
}
?>
          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    <h5>Stock Management System - Admin Panel</h5>
                    <p class="mb-1">
                      <strong>Role:</strong> 
                      <span class="badge badge-primary">
                        <?php echo ucfirst($department) . ' Administrator'; ?>
                      </span>
                    </p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <p>Welcome to the Admin Dashboard. You have limited access as per your assigned permissions.</p>
                <p><strong>Your Permissions:</strong></p>
                <ul>
                  <li>View assigned categories</li>
                  <li>Edit assigned categories</li>
